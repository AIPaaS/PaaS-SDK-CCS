...
public class TestComponent {
    ...
    private String userPwd = CiperUtil.decrypt(ConfigConstant.OPERATORS, "37768f39318b73de4b724b46646f1e4d");
    ...
    public void testadd() throws Exception {
        ...
        client.createNode(ConfigSDKUtil.appendUserReadOnlyPathPath(userName) + readOnlyPathA,
                ConfigSDKUtil.createReadOnlyACL(userName, userPwd, adminName, adminPwd), readonlyValue,
    ...
    public void testGet() throws Exception {
        ZKClient client = ZKFactory.getZkClient(configAddr, adminName, adminPwd);
        System.out
                .println(client.getNodeData(ConfigSDKUtil.appendUserReadOnlyPathPath(userName) + readOnlyPathA, false));
    }
    ...
    public void testModify() throws Exception {
        ...
        assertEquals(readonlyValue,
                client.getNodeData(ConfigSDKUtil.appendUserReadOnlyPathPath(userName) + readOnlyPathA, false));
    }
    ...
    public void testExist1() throws Exception {
        System.out.println(CiperUtil.decrypt(ConfigConstant.OPERATORS, "ec4c9e0e78f76a69"));
    }
