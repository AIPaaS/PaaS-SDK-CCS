...
public class ZKClient {
    ...
    public ZKClient(String zkAddr, int timeOut) throws InterruptedException {
        init(zkAddr, timeOut, null, null);
    }

    public ZKClient(String zkAddr, int timeOut, String authSchema, String authInfo) throws InterruptedException {
        init(zkAddr, timeOut, authSchema, authInfo);
    }

    public ZKClient(String zkAddr, int timeOut, String... auth) throws InterruptedException {
    ...
    private void init(String zkAddr, int timeOut, String authSchema, String authInfo) throws InterruptedException {
        Assert.notNull(zkAddr, "zkAddress should not be Null");
    ...
    public boolean isConnected() {
        return null != client && CuratorFrameworkState.STARTED.equals(client.getState());
    }
    ...
    public ZKClient addAuth(final String authSchema, final String authInfo) throws Exception {
        this.client.getZookeeperClient().getZooKeeper().addAuthInfo(ConfigConstant.ZKAuthSchema.DIGEST,
                authInfo.getBytes());
        return this;
    }
