...
public class CCSComponentFactory {
    ...
    private static transient final Logger logger = LoggerFactory.getLogger(CCSComponentFactory.class);
    //private static Map<String, ICCSComponent> configClientMap = new ConcurrentHashMap<String, ICCSComponent>();
     ...
     */
    public static ICCSComponent getConfigClient(String configAddr, String username, String passwd) throws ConfigException {
     ...
     * @return
     */
    public static ICCSComponent getConfigClient(String configAddr, String username, String passwd, int timeout) throws ConfigException {
        /* 1. 校验参数是否为空 */
        ...
        ICCSComponent client = new ConfigClientImpl(configAddr, username, CiperUtil.decrypt(ConfigCenterConstants.operators, passwd), timeout);
